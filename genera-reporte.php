...
foreach ($reporteGeneral as $key => $valueGeneral) {
        ...
        foreach ($listaProducto as $key => $valuePro) {
            ...
            (id_almacen, nombre_almacen, cotizacion, id_asesor, nombre_vendedor, ced_cliente, fecha_creacion_cliente, fecha, origen_negociacion, cliente_compartido, estado_cliente, visita_almacen, motivo_cliente, fecha_seguimiento, valor_factura, observacion) 
            VALUES 
            (:id_almacen, :nombre_almacen, :cotizacion, :id_asesor, :nombre_vendedor, :ced_cliente, :fecha_creacion_cliente, :fecha, :origen_negociacion, :cliente_compartido, :estado_cliente, :visita_almacen, :motivo_cliente, :fecha_seguimiento, :valor_factura, :observacion)");
