...
<div class="box box-default">
	...
	<div class="box-body">
        ...
        <!--=====================================
        PRODUCTOS CLASIFICADOS CON SU COLOR  Y DESCRIPCION NO USAR POR EL MOMENTO
        ======================================-->
		   <!-- <div class="col-md-5">
...
<?php
// Llenar un array en un bucle for con los 10 primeros productos con mas ventas
$dataPoints = array();
  for($i = 0; $i < 10; $i++){
    
    $dataPoints[] = array(
      'label' => $productos[$i]["descripcion"],
      'y' => $productos[$i]["ventas"]
    );
  }
